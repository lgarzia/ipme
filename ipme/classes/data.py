        ...
        if isinstance(space, list):
            ...
            for sp in space:
                if sp in self._spaces and self._is_var_in_space(var_name, sp):
                    array_name = header_js["inference_data"][sp]["array_names"][
                        var_name
                    ]
                    if (
                        "chain"
                        in header_js["inference_data"][sp]["vars"][var_name]["dims"]
                    ):
            ...
            if space in self._spaces and self._is_var_in_space(var_name, space):
                ...
                if (
                    "chain"
                    in header_js["inference_data"][space]["vars"][var_name]["dims"]
                ):
            ...
            raise ValueError(
                "space argument of get_sample should be either a List of Strings or a String"
            )
